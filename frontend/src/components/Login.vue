<template>  
  <div>  
    ...
    <el-dialog v-model="loginstate.dialogFormVisible" :width="dialogWidth" :center="true" title="登录">  
      <el-form :model="form">  
    ...
    <el-dialog v-model="registerFormVisible" :width="dialogWidth" :center="true" title="注册">  
